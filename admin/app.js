...
// ---------- 全局变量 ----------
let currentPage = null;          // 当前正在编辑的页面对象
let editor = null;              // Monaco 编辑器实例
let currentLanguage = 'html';   // 当前编辑器语言
let pagesList = [];             // 页面列表缓存
